            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-center">
                        <a href="{{ route('dashboard.index') }}" class="btn btn-sm btn-primary">Dashboard</a>
                    </div>
                    <div class="card-body">
                        @include('validate')
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td style="font-size: 12px">@if ($item->payment==2)
                                        ...
                                        @if ($item->pv===0)
                                            <p>Cheque Payment<br>Invoice : <b>{{$item->invoice}}</b><br><span
                                                ...
                                                <a class="text-success" href="{{ route('payment.status.update',$item->ukey) }}"><i
                                            ...
                                            <p>Cheque Payment<br>Invoice : <b>{{$item->invoice}}</b><br><span
                                                ...
                                                <a class="text-danger" href="{{ route('payment.status.update',$item->ukey) }}"><i
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-success"
                                            href="{{ route('trash.update',$item->ukey) }}"><i class="fa fa-undo"
                                                aria-hidden="true"></i></a>
                                        @else
                                        <a class="btn btn-sm btn-danger"
                                            href="{{ route('trash.update',$item->ukey) }}"><i class="fa fa-trash"
                                                aria-hidden="true"></i></a>
                                        @endif
                                    </td>
                                </tr>
